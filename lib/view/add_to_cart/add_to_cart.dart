  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: provider.isEmpty
          ...
          : ListView.builder(
              itemCount: Provider.of<my_provider>(context).cartItems.length,
              itemBuilder: (context, index) => Padding(
                ...
                child: Dismissible(
                  ...
                  key: Key(
                      Provider.of<my_provider>(context).cartItems.toString()),
                  child: Container(
                    height: 200,
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '₹${Provider.of<my_provider>(context).priceCal(
                                          Provider.of<my_provider>(context)
                                              .cartItems[index]
                                              .price!,
                                          //  provider[index].itemCount!
                                        )}',
                                        style: TextStyle(
                                            color: Colors.red,
                                            fontSize: 25,
